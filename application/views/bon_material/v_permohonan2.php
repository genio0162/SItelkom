...
<div class="container-fluid">
    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between shadow mb-4">
            <p class="m-0 text-gray-800">Permintaan / <a href="<?= base_url('dashboard'); ?>">Home</a></p>
    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <form id="quickForm" method="POST" action="<?= base_url('bon_material/tambah') ?>">
                <!--?php var_dump($brg); ?-->
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="card-body">
                    <div class="row">
                        <form id="quickForm" method="POST" action="<?= base_url('bon_material/keluar2') ?>">
                            <button type="submit" name="tambahh" class="btn btn-success btn-flat"><i class="fa fa-paper-plane"></i>&nbsp;Simpan</button>
                        </form> &nbsp;
                        <a href="<?= base_url('bon_material/hapus') ?>" class="btn btn-danger">Kosongkan</a>
                    </div>
                </div>
            </div>
            </form>
