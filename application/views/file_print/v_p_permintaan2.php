    ...
    <div class="container">
        ...
        <div class="row align-items-center container">
            <table class="table table-borderless table-sm">
                <tbody>
                    <tr>
                        <td style="font-family: Arial; font-size: small; width: 150px;">No Permintaan</td>
                        <td style="font-family: Arial; font-size: small;">: <?= $nama['nofrak'] ?></td>
                    </tr>
                    <tr>
                        <td style="font-family: Arial; font-size: small; width: 150px;">Nama Teknisi</td>
                        <td style="font-family: Arial; font-size: small;">: <?= $nama['namatek'] ?></td>
                    </tr>
                    <tr>
                        <td style="font-family: Arial; font-size: small; width: 150px;">Hari & Tanggal</td>
                        <td style="font-family: Arial; font-size: small;">: <?= $nama['tanggal'] ?></td>
                    </tr>
                    <tr>
