        ...
        <script type="text/javascript">
            $(function() {
                $('#report').highcharts({
                    ...
                    title: {
                        text: 'Grafik Total Pengadaan SO INV JEMKOT OUT Bulan <?php echo $bln ?>',
                        style: {
                            fontSize: '18px',
                    ...
                    tooltip: {
                        formatter: function() {
                            return 'Total pengadaan tanggal <b>' + this.x + '</b> adalah <b>' + Highcharts.numberFormat(this.y, 0) + '</b> pengadaan </b>';
                        }
                    },
                    series: [{
                        name: 'Tanggal',
